...
[fastify-example-ts](https://github.com/smartiniOnGitHub/fastify-example-ts).

Documentation generated from source code (API):
[fastify-example-ts - documentation](https://smartiniongithub.github.io/fastify-example-ts/).
