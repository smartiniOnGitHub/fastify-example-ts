...
* [x] general: ensure all works with latest TypeScript (currently '6.0.3'); this will require re-generate and update 'tsconfig.json' file; start by disabling my plugins; check if extension file 'tsconfig.build.json' could be useful too (and describe how to use it here); check/fix TypeScript config config file for types (in the 'types/' folder) need to be updated/fixed too ... wip
